export class EditorHost {
    ...
    start() {
        ...
        filePanel.style.height = (engineUIConfig.assetsPanelHeight - 20).toString();
        ...
        assetsPanel.style.height = (engineUIConfig.assetsPanelHeight - 20).toString();
        ...
        fileHandlePanel.style.height = (engineUIConfig.assetsPanelHeight - 20).toString();
